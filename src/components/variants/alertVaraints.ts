...
export const alertVariants = cva('flex items-center gap-2 border py-3 pe-2 ps-4', {
  variants: {
    color: {
      ...
      yellow:
        'border-yellow-500 bg-yellow-500/10 text-yellow-600 dark:border-yellow-400 dark:bg-yellow-400/10 dark:text-yellow-300',
      violet:
  ...
  'ms-auto flex h-8 w-8 items-center justify-center rounded-full border-none bg-none transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2',
  {
    variants: {
      color: {
        ...
        yellow:
          'text-yellow-600 hover:bg-yellow-500/20 focus:ring-yellow-300 dark:focus:ring-yellow-500',
        violet:
