...
export const messageVariants = cva('flex items-center gap-2 border py-3 pe-2 ps-4', {
  variants: {
    variant: {
      default:
...
export const messageDismissButtonVariants = cva(
  'ms-auto flex h-8 w-8 items-center justify-center rounded-full border-none bg-none transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        mutedContrast:
          'text-muted-700 hover:bg-muted-100 dark:text-muted-200 dark:hover:bg-muted-800 focus:ring-muted-400 dark:focus:ring-muted-600',
        primary:
