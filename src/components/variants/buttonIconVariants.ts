    ...
    compoundVariants: [
      {
        ...
        color: "default",
        className:
          "text-gray-800 bg-white hover:bg-gray-100 active:bg-gray-200",
      },
      {
        variant: "solid",
        color: "contrast",
      ...
      },
      {
        ...
        color: "primary",
        className:
          "text-white bg-blue-600 hover:bg-blue-700 active:bg-blue-500",
      },
      {
        variant: "solid",
        color: "info",
        className:
          "text-white bg-teal-500 hover:bg-teal-600 active:bg-teal-400",
      },
      {
        variant: "solid",
        color: "success",
        className:
          "text-white bg-green-500 hover:bg-green-600 active:bg-green-400",
      },
      {
        variant: "solid",
        color: "warning",
        className:
          "text-white bg-yellow-500 hover:bg-yellow-600 active:bg-yellow-400",
      },
      {
        variant: "solid",
        color: "danger",
      ...
      },
      {
        ...
        color: "violet",
        className:
          "text-white bg-violet-500 hover:bg-violet-600 active:bg-violet-400",
      },
      {
        variant: "outlined",
        color: "default",
      ...
      },
      {
        ...
        color: "contrast",
        className:
          "border border-black text-black hover:bg-gray-50 focus-visible:ring-gray-400",
      },
      {
        variant: "outlined",
        color: "muted",
      ...
      },
      {
        ...
        color: "info",
        className:
          "border border-sky-600 text-sky-600 hover:bg-sky-50 focus-visible:ring-sky-400",
      },
      {
        variant: "outlined",
        color: "success",
      ...
      },
      {
        ...
        color: "danger",
        className:
          "border border-red-600 text-red-600 hover:bg-red-50 focus-visible:ring-red-400",
      },
      {
        variant: "outlined",
        color: "yellow",
