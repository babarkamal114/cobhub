...
export const cardVariants = cva('relative w-full transition-all duration-300 p-4', {
  variants: {
    color: {
      ...
      primary: 'bg-blue-100 text-blue-700 dark:text-blue-400 border border-blue-300',
      ...
      success: 'bg-emerald-100 text-emerald-700 dark:text-emerald-400 border border-emerald-300',
      warning: 'bg-amber-100 text-amber-700 dark:text-amber-400 border border-amber-300',
      danger: 'bg-red-100 text-red-700 dark:text-red-400 border border-red-300',
    },
    shape: {
      straight: '',
      rounded: 'rounded-md',
